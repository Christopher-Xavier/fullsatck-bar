...
describe('Cabinet Endpoints', () => {
  ...
  describe('GET /cabinet/:id', () => {
    ...
    it('Responds 200 with spirits', () => {
      ...
      const expectedSpirits = testSpirits.map((s) =>
        helpers.makeExpectedSpirits(s, testSpiritType)
      );
  ...
  describe('DELETE /cabinet/:id', () => {
    ...
    it('Responds 204 when spirit deleted', () => {
      ...
      const spiritList = testSpirits.map((s) =>
        helpers.makeExpectedSpirits(s, testSpiritType)
      );
      const expectedSpiritList = spiritList.filter(
        (spirit) => spirit.id === spiritToBeDeleted
      );
      return supertest(app)
